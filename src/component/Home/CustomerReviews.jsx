  ...
  <div className="w-full md:w-1/3 lg:w-1/4 p-4">
    <div className="bg-white rounded-lg shadow-lg overflow-hidden text-center">
      <div className="p-4 flex items-center flex-col">
        ...
        <p className="my-4 w-10/12 text-gray-600 text-md">
          “I'm a testimonial. Click to edit me and add text that says something nice about you and your services. Let your customers review you and tell their friends how great you are.”
        </p>
        <p className="mt-2 text-[var(--primary-color)] text-xl font-bold">Dave Reddington</p>
      </div>
    </div>
  </div>
  <div className="w-full md:w-1/3 lg:w-1/4 p-4">
    <div className="bg-white rounded-lg shadow-lg overflow-hidden text-center">
      <div className="p-4 flex flex-col items-center">
        ...
        <p className="mt-2 text-[var(--primary-color)] text-xl font-bold">Amelia Banks</p>
      </div>
    </div>
  </div>
  <div className="w-full md:w-1/3 lg:w-1/4 p-4">
    <div className="bg-white rounded-lg shadow-lg overflow-hidden text-center">
      <div className="p-4 flex flex-col items-center">
        ...
        <p className="my-4 text-gray-600 w-10/12 text-md">
          “I'm a testimonial. Click to edit me and add text that says something nice about you and your services. Let your customers review you and tell their friends how great you are.”
        </p>
        <p className="mt-2 text-[var(--primary-color)] text-xl font-bold">James Lannister</p>
      </div>
    </div>
  </div>
</div>
