...
const CategoryWorkCard = ({item}) => {
  ...
  return (
    ...
    <div className="w-full sm:w-1/4 h-72 overflow-hidden rounded m-2 ">
             <Link style={{backgroundImage:`url(${categorywork.image})`}}  to={`/workItem/${item._id}`} target="_self" className="w-full h-full flex items-center justify-center bg-center bg-cover ')]">
