...
const CategoryWorkCard = () => {
  ...
  return (
    ...
    <div className="w-full sm:w-1/4 h-72 overflow-hidden rounded m-2 ">
             <Link style={{backgroundImage:`url(${categorywork.image})`}}  to={`/workItem`} target="_self" className="w-full h-full flex items-center justify-center bg-center bg-cover ')]">
             <div className=" w-full h-full text-xl flex items-end justify-end  ">
                  <span className='bg-black/50 backdrop-blur-sm px-2 py-1 rounded-lg text-white'>fitting</span>
              </div>
